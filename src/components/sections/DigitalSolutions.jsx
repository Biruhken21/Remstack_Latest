                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
                    {solutions.map((solution, i) => (
                        <motion.div
                            ...
                            className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 p-4 sm:p-5 md:p-6 rounded-xl shadow-sm hover:border-primary hover:shadow-md transition-all min-h-[180px] sm:min-h-[200px] md:min-h-[220px] flex flex-col"
                        >
                            ...
                            <h3 className="text-sm sm:text-base md:text-lg font-bold text-secondary dark:text-white mb-1.5 md:mb-2">{solution.title}</h3>
                            <p className="text-gray-600 dark:text-gray-400 text-xs sm:text-sm md:text-sm leading-relaxed font-medium flex-grow">{solution.desc}</p>
                        </motion.div>
                    ))}
                </div>
            </div>
