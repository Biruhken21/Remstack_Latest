        ...
        <section className="py-16 md:py-24 bg-secondary dark:bg-[#0a0f1a] relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                ...
                >
                    <Link
                        to="/contact"
                        className="w-full sm:w-auto px-6 md:px-10 py-3 md:py-4 bg-gradient-to-r from-primary to-accent text-white rounded-xl font-semibold text-sm md:text-base hover:from-primary-dark hover:to-accent-light transition-all shadow-lg inline-flex items-center justify-center gap-2"
                    >
                        Start Your Project
                    ...
                    <Link
                        to="/portfolio"
                        className="w-full sm:w-auto px-6 md:px-10 py-3 md:py-4 bg-white/10 text-white border border-white/20 rounded-xl font-semibold text-sm md:text-base hover:bg-white/20 transition-all"
                    >
                        View Our Work
                    </Link>
                </motion.div>
